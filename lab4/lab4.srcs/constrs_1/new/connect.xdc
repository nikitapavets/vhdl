...
## Pushbuttons
set_property PACKAGE_PIN P6 [get_ports X[0]]
set_property IOSTANDARD LVCMOS15 [get_ports X[0]]
set_property PACKAGE_PIN R5 [get_ports X[1]]
set_property IOSTANDARD SSTL15 [get_ports X[1]]
set_property PACKAGE_PIN U6 [get_ports X[2]]
set_property IOSTANDARD SSTL15 [get_ports X[2]]
set_property PACKAGE_PIN U5 [get_ports X[3]]
...
## DIP switches
set_property PACKAGE_PIN R8 [get_ports UP]
set_property IOSTANDARD SSTL15 [get_ports UP]
set_property PACKAGE_PIN P8 [get_ports DOWN]
set_property IOSTANDARD SSTL15 [get_ports DOWN]
set_property PACKAGE_PIN R7 [get_ports CLR]
set_property IOSTANDARD SSTL15 [get_ports CLR]
set_property PACKAGE_PIN R6 [get_ports nLOAD]
